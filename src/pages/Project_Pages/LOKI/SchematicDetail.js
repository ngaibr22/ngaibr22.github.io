  ...
  return (
    <HelmetProvider>
      <Container className="project-page">
        <Helmet>
          <title>
            {currentDetail.title} | LOKI | {meta.title}
          </title>
                    ...
                    onClick={
                      subsystem.detailedDescription || subsystem.designNotes?.length
                        ? () =>
                            navigate(
                              subsystemId
                                ? `/project/loki/schematic/${schematic.id}/subsystem/${subsystemId}/subsystem/${subsystem.id}`
                                : `/project/loki/schematic/${schematic.id}/subsystem/${subsystem.id}`
                            )
                        : undefined
                    }
